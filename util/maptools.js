...
//结尾处将该方法暴露出来供外部调用
export default {    
 gcj_decrypt: GPS.gcj_decrypt,
 gcj_encrypt: GPS.gcj_encrypt,
 outOfChina: GPS.outOfChina,
 delta: GPS.delta,
 gcj_decrypt_exact: GPS.gcj_decrypt_exact,
 transformLat: GPS.transformLat,
 transformLon: GPS.transformLon,
}